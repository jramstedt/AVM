				...
				<div id="content">
					<div id="main">
						<div class="center_wrapper">
							...
							<div class="box">
								...
								<div class="box_content" style="display: none;">
									<form method="post">
										...
										<label>Torrent<input type="text" name="torrent" maxlength="255" size="32"></input></label>
										<label>File<input type="text" name="file" maxlength="255" size="32"></input></label>
							...
							<xsl:call-template name="editableMovieList"/>
						</div>
					</div>
				</div>
